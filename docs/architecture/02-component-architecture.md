...
| `AuditPort` | (additive) | `JsonlAuditAdapter`, `OtlpAuditAdapter`, `CloudWatchAuditAdapter` | Q2 designed — [ADR-018](../../../spectra-wt-strategy/docs/strategy/architecture/ADR-018-audit-log-and-identity.md) |
| `CostTrackerPort` | (additive) | `SqliteCostTracker` | Q2 designed — [ADR-013](../../../spectra-wt-strategy/docs/strategy/architecture/ADR-013-task-budget-and-rate-coordination.md) |
| `PolicyPort` | (additive) | `YamlPolicyAdapter` | Q2 designed — roadmap #17 |
| `ReceiptSigner` | (additive) | `Ed25519ReceiptSigner` | Q2 designed — roadmap #57 |
